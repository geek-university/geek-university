...
AdminUser.create([
  { :email => "admin@example.com", :encrypted_password => "$2a$10$dkfkizB7/cmxf258xHA.w.AXQPr3oMnlZNr/KzhmXhJpu1Lzzc3iG", :reset_password_token => nil, :reset_password_sent_at => nil, :remember_created_at => nil, :sign_in_count => 1, :current_sign_in_at => "2013-03-10 23:56:10", :last_sign_in_at => "2013-03-10 23:56:10", :current_sign_in_ip => "127.0.0.1", :last_sign_in_ip => "127.0.0.1", :created_at => "2013-03-10 23:42:07", :updated_at => "2013-03-10 23:56:10" }
...
Student.create([
  { :username => nil, :created_at => "2013-03-11 00:00:43", :updated_at => "2013-03-11 00:00:43", :email => "student@example.com", :encrypted_password => "$2a$10$ybyTImnCpDi/uu9l2MdHeONyzcKtJDTYm3m/sx9BGbY1IImKmgxAO", :reset_password_token => nil, :reset_password_sent_at => nil, :remember_created_at => nil, :sign_in_count => 0, :current_sign_in_at => nil, :last_sign_in_at => nil, :current_sign_in_ip => nil, :last_sign_in_ip => nil, :type => "Student" }
], :without_protection => true )
...
Teacher.create([
  { :username => nil, :created_at => "2013-03-11 00:00:59", :updated_at => "2013-03-11 00:00:59", :email => "teacher@example.com", :encrypted_password => "$2a$10$YLBqrdn2exxUPRVDaxVSVecHOViK5KDo.k6Uu4FbiGI.tmShsy39a", :reset_password_token => nil, :reset_password_sent_at => nil, :remember_created_at => nil, :sign_in_count => 0, :current_sign_in_at => nil, :last_sign_in_at => nil, :current_sign_in_ip => nil, :last_sign_in_ip => nil, :type => "Teacher" }
], :without_protection => true )
