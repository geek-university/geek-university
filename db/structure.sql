...
CREATE TABLE "course_sections" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(255), "date" date, "course_id" integer, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
...
CREATE TABLE "courses" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(255), "short_summary" varchar(255), "description" text, "organisation" varchar(255), "start_date" date, "end_date" date, "published" integer, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "logo_file_name" varchar(255), "logo_content_type" varchar(255), "logo_file_size" integer, "logo_updated_at" datetime);
...
CREATE TABLE "study_materials" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(255), "order" float, "data" text, "course_section_id" integer, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
CREATE TABLE "users" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "username" varchar(255), "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "email" varchar(255) DEFAULT '' NOT NULL, "encrypted_password" varchar(255) DEFAULT '' NOT NULL, "reset_password_token" varchar(255), "reset_password_sent_at" datetime, "remember_created_at" datetime, "sign_in_count" integer DEFAULT 0, "current_sign_in_at" datetime, "last_sign_in_at" datetime, "current_sign_in_ip" varchar(255), "last_sign_in_ip" varchar(255), "type" varchar(255));
...
CREATE INDEX "index_course_sections_on_course_id" ON "course_sections" ("course_id");
...
CREATE INDEX "index_study_materials_on_course_section_id" ON "study_materials" ("course_section_id");
...
INSERT INTO schema_migrations (version) VALUES ('20130310120820');

INSERT INTO schema_migrations (version) VALUES ('20130310120924');

INSERT INTO schema_migrations (version) VALUES ('20130310215156');
