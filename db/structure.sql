...
CREATE TABLE "course_users" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "course_id" integer, "user_id" integer, "material_id" integer, "can_manage" boolean, "last_viewed" date, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
...
CREATE TABLE "lectures" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "youtube_link" varchar(255), "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
CREATE TABLE "materials" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "as_material_id" integer, "as_material_type" varchar(255), "name" varchar(255), "position" float, "section_id" integer, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
...
CREATE INDEX "index_course_users_on_course_id_and_user_id" ON "course_users" ("course_id", "user_id");
